...
{\field{\*\fldinst{HYPERLINK "http://www.codeskulptor.org/#user11_AYrx4nBms6nMjeY_0.py"}}{\fldrslt 
\f0\fs24 \cf0 http://www.codeskulptor.org/#user11_AYrx4nBms6nMjeY_0.py}}
\f0\fs24 \
\
